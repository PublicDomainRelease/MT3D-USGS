...
Included in directory MT3D-USGS_1.0.1\doc is the MT3D-USGS documentation 
...
directory, the directory containing the executables (MT3D-USGS_1.0.1\bin)
should be included in the PATH environment variable.  

As an alternative, the executable files, MT3D-USGS.exe and MT3D-USGS_64.exe, 
in the MT3D-USGS_1.0.1\bin directory can be copied into a directory already
included in the PATH environment variable.


C. EXECUTING THE SOFTWARE

A 32-bit and a 64-bit executable are provided in the MT3D-USGS_1.0.1\bin  
...
After the executable files in the MT3D-USGS_1.0.1\bin directory are installed in
a directory that is included in your PATH, MT3D-USGS is initiated in
a Windows Command-Prompt window using the commands:

      MT3D-USGS_32_1.0.1.exe [Fname]

or
      MT3D-USGS_64_1.0.1.exe [Fname]
...
of MF-NWT greater than or equal to version 1.1.4 must be run with the LMT 
...
The executable files provided in MT3D-USGS_1.0.1\bin were created using the 
